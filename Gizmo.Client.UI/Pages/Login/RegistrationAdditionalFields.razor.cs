...
namespace Gizmo.Client.UI.Pages
{
    ...
    public partial class RegistrationAdditionalFields : ComponentBase
    {
        ...
        {
            Countries = new List<Gizmo.Web.Components.Country>();

            Countries.Add(new Gizmo.Web.Components.Country()
            {
                Id = 1,
                Name = "Georgia",
                PhonePrefix = "+995",
        ...
        public Gizmo.Web.Components.Country SelectedCountry { get; set; }
